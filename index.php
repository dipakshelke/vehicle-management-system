...
<form action="u_login.php" method="post">
  ...
  <div class="container">
    ...
    <input type="text" pattern="[1-9]{1}[0-9]{9}" placeholder="Enter Mobile No." name="u_name" required>
...
<div style="padding:15px;"><a href="u_signup.php" ><span  style="color:white;top:12px;">Don't have an account?</span><button style="width:100px;float:right">Sign Up</button></a></div>
	</div>
<script>
var myIndex = 0;
carousel();
